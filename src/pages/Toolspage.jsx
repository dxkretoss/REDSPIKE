...
import { ArrowLeft, Terminal, ShieldCheck, Radar } from "lucide-react";

const tools = [
    {
        title: "Security Scanner",
        description:
            "Automated scanning tools to detect vulnerabilities across systems and applications.",
        icon: Terminal,
    },
    {
        title: "Compliance Toolkit",
        description:
            "Tools designed to support security compliance and risk assessments.",
        icon: ShieldCheck,
    },
    {
        title: "Threat Intelligence",
        description:
            "Advanced tools for monitoring and analyzing emerging cyber threats.",
        icon: Radar,
    },
];
            ...
            >
                ...
                <div className="text-center mb-14">
                    ...
                    <p className="text-white/70 max-w-2xl mx-auto text-sm lg:text-base">
                        A curated set of security tools built to assist with assessment,
                        monitoring, and defensive operations.
                    </p>
                </div>
